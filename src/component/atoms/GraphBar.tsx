...
const BaseStyled: Record<TypeColor, string> = {
  primary:
    "w-full min-w-[35px] h-full rounded-2xs bg-primary-300 drop-shadow-neutral-1000 drop-shadow-(--shadow-1) ",
  secondary:
    "w-full min-w-[35px] h-full rounded-2xs bg-secondary-300 drop-shadow-neutral-900 drop-shadow-sm",
};
